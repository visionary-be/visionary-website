(function($) {
  ...
  Sortable.prototype.create = function() {
    ...
    dragging.constraint = this.opts.constraint;
  ...
  Sortable.prototype.start = function(e) {
    ...
    if (this.opts.unmove) {
      var unmoveIds = [];
      $(this.el).find(this.opts.unmove).each(function(){
        unmoveIds.push($(this).index())
      })
      this.unmoveIds = unmoveIds;
    }
  ...
  Sortable.prototype.drop = function(e) {
    ...
    if (typeof handler === 'function') {
      ...
      $(this.unmoveIds).each(function(k, index){
        if( index == newIndex){
          allowMove = false;
        }
      })
