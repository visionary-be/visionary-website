...
$(document).ready(function(){function n(){windowHeight=$(window).innerHeight(),fullHeight=windowHeight-100,$(".box-guide").css("min-height",fullHeight)}jQuery.fn.extend({changeLettrine:function(){$(this).each(function(){var n=$(this).html().charAt(0);$(this).attr("data-lettrine",n)})}}),$(".lettrine").changeLettrine(),$("#menu-offcanvas-close").click(function(){UIkit.offcanvas.hide()}),n(),$(window).resize(function(){n()})});
