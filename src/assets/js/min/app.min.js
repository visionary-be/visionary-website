...
$(document).ready(function(){jQuery.fn.extend({changeLettrine:function(){$(this).each(function(){var t=$(this).html().charAt(0);$(this).attr("data-lettrine",t)})}}),$(".lettrine").changeLettrine(),$("#menu-offcanvas-close").click(function(){UIkit.offcanvas.hide()})});
