...
$(document).ready(function(){function e(){windowHeight=$(window).innerHeight(),headerHeight=$("#header").innerHeight()+60,fullHeightBox=windowHeight-headerHeight,fullHeightContent=windowHeight-headerHeight-80,$(".box-guide").css("min-height",fullHeightBox),$(".box-guide-content").css("height",fullHeightContent),console.log(fullHeightContent)}jQuery.fn.extend({changeLettrine:function(){$(this).each(function(){var e=$(this).html().charAt(0);$(this).attr("data-lettrine",e)})}}),$(".lettrine").changeLettrine(),$("#menu-offcanvas-close").click(function(){UIkit.offcanvas.hide()}),e(),$(window).resize(function(){e()})});
