    	...
    	<section id="home-visionary" class="uk-block uk-block-primary block-diagonal off-top uk-text-contrast">
	        ...
	        <div class="uk-width-medium-1-2 uk-container-center">
						<div>
		        	<h2 class="lettrine">A propos de Visionary</h2>
		        	...
		        	<p><a href="/about" class="uk-button uk-button-default uk-button-large">Tout savoir sur ce projet</a></p>
						</div>
	        </div>
	    	</div>
				<div class="uk-grid">
					<div class="uk-width-medium-2-3 uk-container-center">
						...
						<p><a href="/guide" class="uk-button uk-button-secondary">Plus de conseils</a></p>
						</div>
					</div>
				</div>
    	</section>
